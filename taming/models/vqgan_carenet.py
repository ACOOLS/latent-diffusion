...
from taming.modules.diffusionmodules.model_carenet import Encoder, Decoder
...
class VQModel(pl.LightningModule):
    def __init__(self,
        ...
        #print("post_quant_conv")
        #print(self.post_quant_conv)
    ...
    def encode(self, x):
        ...
        return quant, emb_loss, info, h, loss_tensor
