...
from taming.modules.diffusionmodules.model_vit import ViTEncoder as Encoder, ViTDecoder as Decoder
from taming.modules.vqvae.quantize_vit import VectorQuantizer
...
class VQModel(pl.LightningModule):
    ...
    def get_input(self, batch: Tuple[Any, Any], k: str = 'image') -> Any:
        x = batch[k]
    ...
    def configure_optimizers(self) -> Tuple[List, List]:
        ...
        if self.scheduler is not None:
            ...
            scheduler = instantiate_from_config(self.scheduler)
